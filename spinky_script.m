...
train_data_file='xxx.mat';
spindles_visual_score='xxxx.txt';
test_data_file='xxxx.mat';    
showRoc='Off';
...
if (user_defined_thresholds_4_ROC)==1
    switch detection_mode
        case 'spindles'
           ...
           [op_thr_sp] = training_process(tr_data,fs,detection_mode,sp_thresh,sp_train_score,shopRoc);
